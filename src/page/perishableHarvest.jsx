...
import HarvestForm from "../features/perishable/components/harvest";
import TransportForm from "../features/perishable/components/transit";
import StorageMonitor from "../features/perishable/components/store";
  ...
  return (
    <div className="p-6 w-full">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded p-4 mb-4">
        <h4 className="font-bold text-blue-800 mb-2">🐛 Lifecycle Debug</h4>
